...
<div id="wrapper-content">
	<div id="container-content">
		<section class="content-header">
			<h1>
				Bình luận đã được duyệt<small>Tuyển sinh HVN</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/home"><i
						class="fa fa-home"></i> Trang chủ</a></li>
				<li class="active">Bình luận đã được duyệt</li>
			</ol>
			<br>
		</section>
										...
										<table id="table-comment-approved"
											...
											<thead>
												<tr role="row">
													...
													<th style="text-align: center;">Bỏ duyệt</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach var="i" begin="1" end="${listComment.size()}">
													<tr role="row" class="odd">
														...
														<td style="max-width: 400px" class="sorting_1"><c:out
																value="${listComment.get(i-1).getpost().getTitle()}" /></td>
														<td style="max-width: 200px" class="sorting_1"><c:out
																value="${listComment.get(i-1).getComment()}" /></td>
														<td><c:out value="${listComment.get(i-1).getName()}" /></td>
														<td><c:out
																value="${listComment.get(i-1).showCreatedDate()}" /></td>
														<td style="text-align: center;"><form
																id="form-unapproved-comment-${i}"
																action="editor/unapproved" method="POST">
																<input name="commentId" type="hidden"
																	value="${listComment.get(i-1).getId()}"> <input
																	name="approved" type="hidden" value="approved"><a
																	href="#" class="fa fa-remove" title="Bỏ duyệt"
																	onclick='unapprovedComment("${i}")'></a>
															</form></td>
													</tr>
												</c:forEach>
											</tbody>
